...
import com.revature.trms.dao.MySubmissionsDAO;
import com.revature.trms.forms.SubmissionForm;
import com.revature.trms.struct.Token;

/**
 * Servlet implementation class MySubmissions
 */
public class MySubmissions extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		List<SubmissionForm> SubForms = MySubmissionsDAO.getMySubmissions(token);
